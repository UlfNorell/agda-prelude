...
private
  ...
  encodeClause np i c =
    do args ← drop np <$> argTel c
    -| xs   := reverse (mapIx const args)
...
deriveTreeEncoding iname dname =
  do declareDef (iArg iname) =<< instanceType dname (quote TreeEncoding)
