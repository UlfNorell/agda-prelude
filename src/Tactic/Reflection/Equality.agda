...
private
  ...
  eqSort (prop t) (prop t₁) = decEq₁ prop-inj (eqTerm t t₁)
  eqSort (propLit n) (propLit n₁) = decEq₁ spropLit-inj (n == n₁)
  eqSort (inf n) (inf n₁)         = decEq₁ sinf-inj (n == n₁)
  ...
  eqSort (set t) (prop t₁)    = no λ ()
  eqSort (set t) (propLit n)  = no λ ()
  eqSort (set t) (inf n)      = no λ ()
  eqSort (lit n) (prop t)     = no λ ()
  eqSort (lit n) (propLit n₁) = no λ ()
  eqSort (lit n) (inf n₁)     = no λ ()
  eqSort (prop t) (set t₁)    = no λ ()
  eqSort (prop t) (lit n)     = no λ ()
  eqSort (prop t) (propLit n) = no λ ()
  eqSort (prop t) (inf n)     = no λ ()
  eqSort (prop t) unknown     = no λ ()
  eqSort (propLit n) (set t)  = no λ ()
  eqSort (propLit n) (lit n₁) = no λ ()
  eqSort (propLit n) (prop t) = no λ ()
  eqSort (propLit n) (inf n₁) = no λ ()
  eqSort (propLit n) unknown  = no λ ()
  eqSort (inf n) (set t)      = no λ ()
  eqSort (inf n) (lit n₁)     = no λ ()
  eqSort (inf n) (prop t)     = no λ ()
  eqSort (inf n) (propLit n₁) = no λ ()
  eqSort (inf n) unknown      = no λ ()
  eqSort unknown (prop t)     = no λ ()
  eqSort unknown (propLit n)  = no λ ()
  eqSort unknown (inf n)      = no λ ()
