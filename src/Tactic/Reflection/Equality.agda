...
private
  ...
  eqTerm (agda-sort _) (quote-goal _) = no λ ()
  eqTerm (agda-sort _) (quote-term _) = no λ ()
  eqTerm (agda-sort _) quote-context = no λ ()
  eqTerm (agda-sort _) (unquote-term _ _) = no λ ()
  ...
  eqTerm (quote-goal _) (agda-sort _) = no λ ()
  ...
  eqTerm (quote-term _) (agda-sort _) = no λ ()
  ...
  eqTerm quote-context (agda-sort _) = no λ ()
  ...
  eqTerm (unquote-term _ _) (agda-sort _) = no λ ()
